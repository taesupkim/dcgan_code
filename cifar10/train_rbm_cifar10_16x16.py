...
# SET UPDATER #
###############
d_updater = updates.RMSprop(lr=sharedX(0.00001), rho=0.5, regularizer=updates.Regularizer(l2=l2))
g_updater = updates.RMSprop(lr=sharedX(0.00001), rho=0.5, regularizer=updates.Regularizer(l2=l2))
