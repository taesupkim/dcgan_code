...
# SET UPDATER #
###############
d_updater = updates.SGD(lr=sharedX(0.001), regularizer=updates.Regularizer(l2=l2))
g_updater = updates.SGD(lr=sharedX(0.001), regularizer=updates.Regularizer(l2=l2))
