...
# SET UPDATER #
###############
d_updater = updates.RMSprop(lr=sharedX(0.001), rho=0.9, regularizer=updates.Regularizer(l2=l2))
g_updater = updates.RMSprop(lr=sharedX(0.001), rho=0.9, regularizer=updates.Regularizer(l2=l2))
