...
model_name  = 'ENERGY_RBM_BEDROOM_TANH_MEAN_NOISE_NIPS'
...
def set_energy_update_function(energy_feature_function,
    ...
    # get energy updates
    energy_updates, energy_optimizer_params  = energy_optimizer(energy_params,
                                                                energy_updates_cost,
...
def set_generator_update_function(energy_feature_function,
    ...
    generator_updates, generator_optimizer_params  = generator_optimizer(generator_params[0]+generator_params[1],
