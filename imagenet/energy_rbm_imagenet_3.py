...
model_name  = 'ENERGY_RBM_IMAGENET_BIAS_ADAGRAD_STEP_BY_STEP_TANH'
...
if __name__=="__main__":
    ...
    if is_training is True:
        ...
        model_config_dict['hidden_size']         = 1024
        model_config_dict['expert_size']         = 8192
        model_config_dict['min_num_gen_filters'] = 256
        model_config_dict['min_num_eng_filters'] = 256
