...
model_name  = 'ENERGY_RBM_IMAGENET'
...
def set_generator_model(num_hiddens,
    ...
    generator_entropy_params = [bn_w0,
                                bn_w1,
                                bn_w2]
...
def train_model(data_stream,
    ...
    [generator_function, generator_params, _] = set_generator_model(model_config_dict['hidden_size'],
    ...
    for e in xrange(model_config_dict['epochs']):
        ...
        for b, batch_data in enumerate(batch_iters):
            ...
            updater_inputs = [input_data,
                              hidden_data,
                              e]
            [input_energy_val, sample_energy_val, ] = updater_function(*updater_inputs)
