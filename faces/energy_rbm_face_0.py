...
def set_generator_model(num_hiddens,
    ...
    # set of generator entropy related parameters
...
def set_energy_model(num_hiddens,
    ...
    def energy_function(feature_data, is_train=True):
        ...
        e += 0.5*T.sum(T.sqr(feature_data), axis=1).reshape((feature_data.shape[0],1))
        return e
